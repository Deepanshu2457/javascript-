...
// mix question practice 


// let arr = [8,13,15,3,2,9]
...
// let number =[3,16,48,33,18,45,78,32]
...
//     return count
// }
// console.log(countVowel("javascripiiot"));
...
// let totalMark= 0
// for(let i=0; i<student.length; i++){
//         totalMark = totalMark + student[i].marks
//     }
// }
...
//         totalMark = totalMark + student[i].marks
// }
// let  avarge=  totalMark / student.length
// console.log(avarge);

// // lowest marks 

// let lowestmarks = student[0].marks
// let lowestStudent = student[0].name

// for(let i =0 ; i<student.length ; i++){
//     if(student[i].marks < lowestmarks){
//         lowestmarks = student[i].marks
//         lowestStudent = student[i].name
//     }
// }
...
// }
// let avarge = total / students.length
// console.log(avarge);

// let highestMarks =students[0].marks
// let highMrkStudent = students[0].name

// for(let i=0; i<students.length;i++){
//     if(students[i].marks > highestMarks){
//         highestMarks =students[i].marks
//         highMrkStudent = students[i].name

//     }
// }

// console.log(highMrkStudent);
// console.log(highestMarks);
...
//     actualNum = actualNum + arr[i]
// }
//   actualNum =   expectedNum - actualNum
